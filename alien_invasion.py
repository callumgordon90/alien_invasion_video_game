...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #Method to create an alien fleet:
        self._create_fleet()
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            self.sb.prep_score()
            #Increment level when fleet is destroyed:
            self.sb.prep_level()
            #Display number of ships on screen:
            self.sb.prep_ships()
    ...
    #helper method to creat a fleet of aliens:
    def _create_fleet(self):
        """Create the fleet of aliens."""
        #Create an alien and find the number of aliens in a row
        #Spacing between each alien is equal to one alien width
        alien = Alien(self)
        #define size of each individual alien:
        ...
        for row_number in range(number_rows):
            ...
            for alien_number in range(number_aliens_x):
                if number_aliens_x < 1 or number_rows < 1:
                    print("Warning: Not enough space to create the fleet!")
    ...
    def _update_aliens(self):
        ...
        if pygame.sprite.spritecollideany(self.ship, self.aliens):
            self._ship_hit()
            #print("Spank me wasp, i-ve been stung by the bugger!!!")
